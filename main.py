...
# -------------------------------------------------------------------
# SECTION 4: CAMPUS EVENTS MANAGER
# -------------------------------------------------------------------
with tab4:
...
# -------------------------------------------------------------------
# SECTION 6: THE FINAL ANNUAL REPORT (Isolated Section Dashboard)
# -------------------------------------------------------------------
with tab6:
    ...
    if not st.session_state.students:
        ...
        st.markdown("<br>### 📊 Visual Performance Metrics Graph (Vertical Distribution)", unsafe_allow_html=True)
